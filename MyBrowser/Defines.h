...
//  Copyright (c) 2020 ZhangYiming. All rights reserved.
//
...
//#define HOME_URL [[NSURL alloc] initWithString:@"http://scp-wiki-cn.wikidot.com"]
//#define Search_URL @"http://scp-wiki-cn.wikidot.com/search:site/q/%@"
